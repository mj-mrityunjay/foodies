...
import {useSharedData} from '../../index';
	            ...
	            <Row className="d-flex align-items-center">
	               <Col md={8}>
	                  <div className="homepage-search-title">
	                     <h1 className="mb-2 font-weight-normal"><span className="font-weight-bold">{useSharedData('username')} Awesome Deals</span> in India</h1>
	                     <h5 className="mb-5 text-secondary font-weight-normal">Lists of top restaurants, cafes, pubs, and bars in Chennai, based on trends</h5>
	                  </div>
	               ...
	               <Col md={4}>
	                  <div className="osahan-slider pl-4 pt-3">
	                     <OwlCarousel nav loop {...options2} className="homepage-ad owl-theme">
	                        <div className="item">
								<ProductBox 
							   		image='https://tireades.sirv.com/img/slider.png'
	                        ...
	                        <div className="item">
								<ProductBox 
							   		image='https://tireades.sirv.com/img/slider1.png'
							   		imageClass='img-fluid rounded'
							   		imageAlt='carousel'
							   		linkUrl='listing'
							   	/>
