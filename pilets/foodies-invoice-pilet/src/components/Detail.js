      	  ...
      	  users:[
      	  	{
      	  		...
      	  		image:'https://tireades.sirv.com/https://tireades.sirv.com/img/user/5.png',
      	  		url:'#'
      	  	},
      	  	{
      	  		name:'Mrityunjay Kumar',
      	  		image:'https://tireades.sirv.com/https://tireades.sirv.com/img/user/2.png',
      	  		url:'#'
      	  	},
      	  	{
      	  		name:'Askbootstrap',
      	  		image:'https://tireades.sirv.com/https://tireades.sirv.com/img/user/3.png',
      	  		url:'#'
      	  	},
      	  	{
      	  		name:'Osahan Singh',
      	  		image:'https://tireades.sirv.com/https://tireades.sirv.com/img/user/4.png',
      	  		url:'#'
      	  	}
      	  ]
	    };
		...
		<>
    	  <section className="restaurant-detailed-banner">
	         <div className="text-center">
	            <Image fluid className="cover" src="https://tireades.sirv.com/img/mall-dedicated-banner.png" />
	         </div>
		        ...
		        <Container>
		            <Row>
							    ...
							    <Tab.Content className='h-100'>
		                        	  ...
		                        	  <ItemsCarousel />
			                           ...
			                           <Row>
			                              ...
			                              <Col md={4} sm={6} className="mb-4">
			                                 <BestSeller 
												...
												subTitle='North Indian • American • Pure veg'
											  	imageAlt='Product'
											    image='https://tireades.sirv.com/img/list/1.png'
			                              ...
			                              <Col md={4} sm={6} className="mb-4">
			                                 <BestSeller 
												id={2}
										   		title='The Sangeetha Restaurant'
												subTitle='North Indian • American • Pure veg'
											  	imageAlt='Product'
											    image='https://tireades.sirv.com/img/list/6.png'
											    imageClass='img-fluid item-img'
												price={250}
												priceUnit='$'
												qty={1}
			                              ...
			                              <Col md={4} sm={6} className="mb-4">
			                                 <BestSeller 
												...
												subTitle='North Indian • American • Pure veg'
											  	imageAlt='Product'
											    image='https://tireades.sirv.com/img/list/3.png'
											    imageClass='img-fluid item-img'
												price={250}
												priceUnit='$'
												showPromoted={true}
			                              ...
			                              <Col md={12}>
			                                 <div className="bg-white rounded border shadow-sm mb-4">
			                                 	<QuickBite 
													id={1}
													itemClass="menu-list"
													image="https://tireades.sirv.com/img/5.jpg"
											   		title='Chicken Tikka Sub'
													price={250}
													priceUnit='$'
													getValue={this.getQty}
				                                ...
				                                <QuickBite 
													...
													itemClass="menu-list"
											   		title='Cheese corn Roll'
													image="https://tireades.sirv.com/img/2.jpg"
													price={600}
													showBadge={true}
													badgeText='BEST SELLER'
													qty={1}
				                                ...
				                                <QuickBite 
													id={3}
													itemClass="menu-list"
													image="https://tireades.sirv.com/img/3.jpg"
											   		title='Chicken Tikka Sub'
													price={250}
													showBadge={true}
													badgeText='Pure Veg'
						            ...
						            <Tab.Pane eventKey="third">
						            	<div id="restaurant-info" className="bg-white rounded shadow-sm p-4 mb-4">
			                              ...
			                              <p className="mb-2 text-black"><Icofont icon="email text-primary mr-2" /> mks.mrityunjay@gmail.com, osahaneat@gmail.com</p>
						            ...
						            <Tab.Pane eventKey="fifth">
			                            ...
			                            <div className="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
			                              ...
			                              <Review
			                              	image="https://tireades.sirv.com/img/user/1.png"
											ImageAlt=""
											ratingStars={5}
											Name='Singh Osahan'
											profileLink="#"
			                              ...
			                              <hr />
			                              <Review
			                              	image="https://tireades.sirv.com/img/user/6.png"
											ImageAlt=""
											ratingStars={5}
											Name='Mrityunjay Kumar'
											profileLink="#"
		               ...
		               <div className="bg-white rounded shadow-sm text-white mb-4 p-4 clearfix restaurant-detailed-earn-pts card-icon-overlap">
		                     <Image fluid className="float-left mr-3" src="https://tireades.sirv.com/img/earn-score-icon.png" />
	                     ...
	                     <div className="mb-2 bg-white rounded p-2 clearfix">
	                        <Image fluid className="float-left" src="https://tireades.sirv.com/img/wallet-icon.png" />
