	...
	render() {
    	return (
           ...
           expanded={this.state.isNavExpanded} color="light" expand='lg' className="navbar-light osahan-nav shadow-sm">
			   <Container>
			      <Navbar.Brand to="/"><Image src="https://tireades.sirv.com/img/foodies.png" alt='' /></Navbar.Brand>
			      <Navbar.Toggle/>
			      <Navbar.Collapse id="navbarNavDropdown">
			         <Nav activeKey={0} className="ml-auto" onSelect={this.closeMenu}>
						<Nav.Link eventKey={0} as={NavLink} activeclassname="active" exact to="/Index">
			            ...
			            <NavDropdown title="Restaurants" alignRight className="border-0">
							...
							<NavDropdown.Item eventKey={2.3} as={NavLink} activeclassname="active" to="/dynamiccheckout">Dynamic Checkout</NavDropdown.Item>
			            </NavDropdown>
			            ...
			            <NavDropdown alignRight
			            	title={
			            		<DropDownTitle 
			            			...
			            			image="https://tireades.sirv.com/img/user/MJ.png"
			            			imageAlt='user'
