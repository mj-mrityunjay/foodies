    	...
    	return (
	      <>
		      <OwlCarousel ref={this.Carousel}  nav loop {...options} className="owl-theme homepage-ad">
		         <div className="item">
		         	<Image fluid src="https://tireades.sirv.com/img/gallery/1.png" />
		         </div>
		         <div className="item">
		         	<Image fluid src="https://tireades.sirv.com/img/gallery/2.png" />
		         </div>
		         <div className="item">
		         	<Image fluid src="https://tireades.sirv.com/img/gallery/3.png" />
		         </div>
		         <div className="item">
		         	<Image fluid src="https://tireades.sirv.com/img/gallery/1.png" />
		         </div>
