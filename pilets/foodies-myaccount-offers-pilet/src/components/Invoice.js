		               ...
		               <Col md={8} className="mx-auto">
		                  <div className="p-5 osahan-invoice bg-white shadow-sm">
		                     <Row className="mb-5 pb-3">
		                        <Col md={8} xs={10}>
		                           <h3 className="mt-0">Thanks for choosing <strong className="text-secondary">Osahan Eat</strong>, Mrityunjay ! Here are your order details: </h3>
		                        </Col>
		                        <Col md={4} xs={2} className="pl-0 text-right">
		                           ...
		                           <Image alt="logo" src="https://tireades.sirv.com/img/favicon.png" />
		                        </Col>
		                     </Row>
		                     <Row>
		                        <Col md={6}>
		                        ...
		                        <Col md={12}>
		                           ...
		                           <Table className="mt-3 mb-0">
		                              ...
		                              <tbody>
		                                 ...
		                                 <tr>
		                                    <td className="text-right" colSpan="2">Discount Applied (MRITYUNJAY50):</td>
