			            ...
			            <Row>
			               <Col md={4} sm={12}>
			                  ...
			                  <div className="app">
			                     ...
			                     <Link to="#">
			                     	<Image src="https://tireades.sirv.com/img/google.png" alt='' fluid />
			                     </Link>
			                     <Link to="#">
			                     	<Image src="https://tireades.sirv.com/img/apple.png" alt='' fluid />
			                     </Link>
			                  </div>
			               </Col>
...
Footer.defaultProps = {
	...
	popularFood: [],
	copyrightText: '© Copyright 2020 foodies. All Rights Reserved',
	madewithIconclassName: 'heart heart-icon text-danger',
	firstLinkText: 'Mrityunjay Kumar',
	firstLink: "//www.instagram.com/mrityunjaykumar/",
	secondLinkText: 'Nitin',
	secondLink: '//prekshaindustries.com/',
}
